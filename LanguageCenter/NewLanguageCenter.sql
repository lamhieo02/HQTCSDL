--version updated
create database LanguageCenter3
go
use LanguageCenter3
go
...
go
insert into Accounts (Username,Password,Is_Active,roleID) values('hocsinh1','123456',1,3)
insert into Accounts (Username,Password,Is_Active,roleID) values('hocsinh2','123456',0,3)
insert into Accounts (Username,Password,Is_Active,roleID) values('teacher1','123456',0,4)
insert into Accounts (Username,Password,Is_Active,roleID)values('teacher2','123456',1,4)
insert into Accounts (Username,Password,Is_Active,roleID) values('admin1','123456',1,1)
insert into Accounts (Username,Password,Is_Active,roleID) values('admin2','123456',0,1)
insert into Accounts (Username,Password,Is_Active,roleID) values('Staff1','123456',0,2)
insert into Accounts (Username,Password,Is_Active,roleID) values('Staff2','123456',0,2)
...
go
insert into Staff values('Staff1','position 1','01-12-2000','345 Tran Dai Nghia','Lien','Nguyen','liennguyen123@gmail.com','1234567890')
insert into Staff values('Staff2','position 2','07-15-1999','345 Le Loi','Hoang','Tran','tranhoang123@gmail.com','1234566890')
...
alter table Accounts drop constraint CheckPassword_Accounts
