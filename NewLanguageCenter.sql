...
insert into Roles values ('Nhan vien');
insert into Roles values ('Giang vien');
insert into Roles values ('Hoc vien');
...
insert into Accounts values('hocsinh1','Mtl@91202',1,'',4);
insert into Accounts values('hocsinh2','Mtl@91202',0,'',4);
insert into Accounts values('teacher1','Mtl@91202',0,'',3);
insert into Accounts values('teacher2','Mtl@91202',1,'',3);
...
create view AllOf_Accounts as
select Accounts.Username, Accounts.Password, Accounts.Activestatus, Roles.name
from Accounts left join Roles on Accounts.roleID=Roles.ID
go
